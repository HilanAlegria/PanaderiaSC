// API-Panaderia-SC/src/main/java/com/example/API_Panaderia/controller/ProductoController.java
package com.example.API_Panaderia.SC.controller;

import com.example.API_Panaderia.model.Producto; // Ajustado a la ruta de tu modelo (singular)
import com.example.API_Panaderia.repository.ProductoRepository; // Ajustado a la ruta de tu repositorio
